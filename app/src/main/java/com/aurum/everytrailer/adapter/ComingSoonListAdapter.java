 ...
 */
public class ComingSoonListAdapter extends ArrayAdapter<ComingSoonBean> {

    LayoutInflater inflater;
    Context context;
    ArrayList<ComingSoonBean> list;

    public ComingSoonListAdapter(Context context, ArrayList<ComingSoonBean> list) {
