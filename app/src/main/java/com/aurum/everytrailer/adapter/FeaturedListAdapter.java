 ...
 */
public class FeaturedListAdapter extends ArrayAdapter<FeaturedBean> {

    LayoutInflater inflater;
    Context context;
    ArrayList<FeaturedBean> list;

    public FeaturedListAdapter(Context context, ArrayList<FeaturedBean> list) {
