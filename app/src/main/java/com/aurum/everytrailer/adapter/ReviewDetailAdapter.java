...
/**
 * Created by VarunBarve on 11/27/2015.
 */
public class ReviewDetailAdapter extends BaseAdapter {
    ...
    public ReviewDetailAdapter(Context context, ArrayList<ReviewBean> list, String userId) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.review_profile_pic = (ImageView) convertView.findViewById(R.id.review_profile_pic);
        ...
        String imageUrlProfilePic = list.get(position).getProfilePic().replace(" ", "%20");

        Picasso.with(context).load(imageUrlProfilePic).placeholder(R.drawable.actionbar_bg).into(holder.review_profile_pic);
    ...
    class ViewHolder {
        ...
        ImageView shareimg, likeimg, review_profile_pic;
        RatingBar ratingBar;
    }
