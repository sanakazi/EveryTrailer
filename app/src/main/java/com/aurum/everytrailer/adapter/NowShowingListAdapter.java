 ...
 */
public class NowShowingListAdapter extends ArrayAdapter<NowShowingBean> {

    LayoutInflater inflater;
    Context context;
    ArrayList<NowShowingBean> list;

    public NowShowingListAdapter(Context context, ArrayList<NowShowingBean> list) {
