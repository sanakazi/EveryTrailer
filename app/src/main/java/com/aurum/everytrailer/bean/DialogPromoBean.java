 ...
 */
public class DialogPromoBean {

    private String title, trailerId, movieId, videoImageURL, videoURL, videoViewCount, userLike, totalLikeCount;

    public DialogPromoBean(String title, String trailerId, String movieId, String videoImageURL, String videoURL, String videoViewCount, String userLike, String totalLikeCount) {
        this.title = title;
